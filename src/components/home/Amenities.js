        ...
        <div className='amenities'>
            ...
            <div className='amenities-amenities'>
                ...
                <div className='amenities-1'>
                    <div className='amenities-1-title'>Hair</div>
                    <div className='amenities-1-desc'>
                    ...
                    <div className='amenities-1-img'>image</div>
                </div>

                <div className='amenities-1'>
                    <div className='amenities-1-title'>Spa & Waxing</div>
                    <div className='amenities-1-desc'>
                ...
                <div className='amenities-1'>
                    <div className='amenities-1-title'>Nails</div>
                    <div className='amenities-1-desc'>
